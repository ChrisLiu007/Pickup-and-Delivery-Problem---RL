...
class StatePDP(NamedTuple):
    ...
    def __getitem__(self, key):
        if torch.is_tensor(key) or isinstance(key, slice):  # If tensor, idx all tensors by this tensor:
            return self._replace(
                ...
                forbidden=self.forbidden[key],
                visited2=self.visited2[key]
            )
    ...
    def update(self, selected):
        ...
        # EDIT Jakob: Same as for visited_, but I couldn't simply copy because of type differences, so instead I do it equally
        visited2 = self.visited2.scatter(-1, prev_a[:, :, None], 1)
        ...
        return self._replace(
            ...
            lengths=lengths, cur_coord=cur_coord, i=self.i + 1, visited2=visited2
        )
