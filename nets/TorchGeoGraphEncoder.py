...
class GATConvclass(MessagePassing):
    ...
    def message(self, edge_index_i, V_i, Q_j, K_i, size_i):  # i represents node itself, j other one.
    ...
    def aggregate(self, inputs, edge_index_j, dim_size= None):
        return scatter(inputs, edge_index_j, dim=self.node_dim, dim_size=dim_size, reduce=self.aggr)
